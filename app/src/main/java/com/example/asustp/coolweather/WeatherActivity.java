package com.example.asustp.coolweather;
...
import com.example.asustp.coolweather.gson.Forecast;
import com.example.asustp.coolweather.gson.Weather;
import com.example.asustp.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(weatherString!=null){
            ...
            mWeatherId = getIntent().getStringExtra("weather_id");      //Fragment中启动传来的
    ...
    public void requestWeather(final String weatherId){
        ...
        mWeatherId=weatherId;//此处书中没有

        String weatherUrl = "http://guolin.tech/api/weather?cityid=" +
//                weatherId + "&key=bc0418b57b2d4918819d3974ac1285d9";
                   weatherId + "&key=6fe11d7282214758807de487c1810ed8";
