package com.example.asustp.coolweather.util;
...
public class Utility {
    ...
    public static Weather handleWeatherResponse(String response){
        try {
            JSONObject jsonObject = new JSONObject(response);//总的天气情况
            JSONArray jsonArray = jsonObject.getJSONArray("HeWeather");//提取出来的HeWeather部分的JSON数据
